namespace BusinessLayer
{
    ...
    {
        public static string PasswordTemplate(string password)
        {
            return $@"
                                    ...
                                    <table class='container text-center'>
                                        <tbody>
                                                                    ...
                                                                    <table>
                                                                        <tr>
                                                                            <th>
                                                                                ...
                                                                                <center data-parsed=''>
                                                                                    <img src='https://www.sendwithus.com/assets/img/zurb-template-images/cat-placeholder.png'
                                                            ...
                                                            <tr>
                                                                <th class='small-12 large-12 columns first last'>
                                                                    <table>
                                                                        <tr>
                                                                            <th>
                                                                                <h5 class='text-center'>Tu Contraseña es:</h5>
                                                                            </th>
                                                                            <th class='expander'></th>
                                                                        </tr>
                                                                    </table>
                                                                ...
                                                                <th class='grey small-12 large-12 columns'>
                                                                    <table>
                                                                        <tr>
                                                                            <th>
                                                                                <br>
                                                                                <h5 class='text-center' valign='middle'>
                                                                                    {password}</h5>
                                                                            </th>
                                                                            <th class='expander'></th>
                                                                        </tr>
                                          ...
                                          <v:roundrect xmlns:v='urn:schemas-microsoft-com:vml' xmlns:w='urn:schemas-microsoft-com:office:word' href='#' style='height:40px;v-text-anchor:middle;width:200px;' arcsize='8%' strokecolor='#f7931d' fillcolor='#f7931d'>
                                            <w:anchorlock/>
                                            <center style='color:#ffffff;font-family:sans-serif;font-size:16px;font-weight:bold;'>Click Para Iniciar Sesión</center>
                                          </v:roundrect>
                                      <![endif]-->
                                                                                        <a href='#'
                                                                                            style='background-color:#f7931d;border:0px solid #f7931d;border-radius:3px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;mso-hide:all;'>Click
                                                                                            Para Iniciar Sesión</a>
                                                                                    </div>
                                                                                </center>
                                                                            </th>
                                                                            <th class='expander'></th>
                                                            ...
                                                            <tr>
                                                                <th class='small-12 large-12 columns first last'>
                                                                    <table>
                                                                        <tr>
                                                                            <th>
                                                                                <p class='text-center footercopy'>&#xA9; Copyright 2022
                                                                                    Mimados. Todos Los Derechos Reservados.</p>
                                                                            </th>
                                                                            <th class='expander'></th>
                                                                        </tr>
                                                                    </table>
