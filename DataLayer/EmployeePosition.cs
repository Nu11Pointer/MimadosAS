...
namespace DataLayer
{
    ...
    {
        private readonly string _commandText = "sp_employeeposition";

        public bool Create(Entity.EmployeePosition department, out string message)
        {
            bool result;
        ...
        {
            var positions = new List<Entity.EmployeePosition>();
                ...
                using (var connection = new SqlConnection(Connection.value))
                {
                    ...
                    using (var reader = cmd.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            positions.Add(new Entity.EmployeePosition()
                            {
        ...
        public bool Update(Entity.EmployeePosition department, out string message)
        {
            bool result;
        ...
        public bool Delete(Entity.EmployeePosition department, out string message)
        {
            bool result;
